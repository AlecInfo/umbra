  ...
  .group(() => {
    ...
    router
      .group(() => {
        ...
        router.get('/orgs/contacts', [OrgsController, 'contacts'])
    ...
    router
      .group(() => {
        ...
        router.get('/orgs', [AdminController, 'orgs'])
        router.patch('/orgs/:id', [AdminController, 'updateOrg'])
        router.post('/orgs/:id/members', [AdminController, 'addOrgMember'])
        router.patch('/orgs/:id/members/:userId', [AdminController, 'updateOrgMember'])
        router.delete('/orgs/:id/members/:userId', [AdminController, 'removeOrgMember'])
