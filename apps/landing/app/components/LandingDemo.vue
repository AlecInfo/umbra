...
const NODES: DemoNode[] = [
  { name: 'raspi-home', ip: '100.64.0.1', loc: 'Geneva, CH', ms: 2, cpu: 12, cat: 'sbc', icon: 'i-lucide-cpu', status: 'online' },
  { name: 'synology-home', ip: '100.64.0.2', loc: 'Geneva, CH', ms: 3, cpu: 8, cat: 'nas', icon: 'i-lucide-hard-drive', status: 'online' },
...
function connect(n: DemoNode) {
  connName.value = n.name
}
function disconnect() {
  connName.value = ''
}
            ...
            <div class="dm-page">
              <div class="dm-page-header">
                <div>
                  ...
                  <div class="dm-page-sub">
                    {{ onlineCount }}/{{ NODES.length }} {{ t('dm_nodes_online') }}
                  </div>
                </div>
              ...
              <div class="dm-card">
                ...
                >
                  ...
                  <span
                    class="dm-cell-m"
                    :style="connName === n.name ? 'color:var(--accent)' : ''"
                  >
                    {{ n.ms != null ? n.ms + 'ms' : '—' }}
                  </span>
                  <!-- CPU -->
                  <span
                    class="dm-cell-m"
                    :style="n.cpu != null && n.cpu > 70 ? 'color:var(--warning)' : n.cpu == null ? 'opacity:.3' : ''"
                  >
                    {{ n.cpu != null ? n.cpu + '%' : '—' }}
                  </span>
                  <!-- Action -->
            ...
            <Transition name="dm-vpn">
              ...
              >
                ...
                <div class="dm-vpn-info">
                  ...
                  <div class="dm-vpn-detail">
                    {{ connNode.ip }} · WireGuard · umbra0
                  </div>
                </div>
                <div class="dm-vpn-stats">
                  <div class="dm-vstat">
                    <div class="dm-vstat-val">
                      {{ connNode.ms }}ms
                    </div>
                    <div class="dm-vstat-lbl">
                      {{ t('dm_latency') }}
                    </div>
                  </div>
                  <div class="dm-vstat">
