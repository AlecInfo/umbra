    ...
    <div class="login-right">
      ...
      <div class="theme-toggle">
        <button v-for="t in themes" :key="t.value"
                ...
                :title="t.label" @click="setTheme(t.value)">
        ...
        <div class="form-fields">
          ...
          <div class="form-group">
            ...
            <div class="input-wrap">
              <input v-model="password" class="form-input" :type="showPwd ? 'text' : 'password'" placeholder="••••••••••••" />
              <button class="eye-btn" @click="showPwd = !showPwd">
                <svg v-if="!showPwd" width="13" height="13" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="3" stroke="currentColor" stroke-width="1.4"/><path d="M1 8s3-5 7-5 7 5 7 5-3 5-7 5-7-5-7-5z" stroke="currentColor" stroke-width="1.4"/></svg>
                <svg v-else width="13" height="13" viewBox="0 0 16 16" fill="none"><path d="M2 2l12 12M6.5 6.7A3 3 0 009.3 9.5M4.2 4.3C2.6 5.4 1 8 1 8s3 5 7 5c1.4 0 2.7-.4 3.8-1.2M6.5 3.1C7 3 7.5 3 8 3c4 0 7 5 7 5s-.8 1.4-2 2.7" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg>
              </button>
            </div>
          </div>
          <!-- Password strength -->
          <div class="pwd-strength">
            <div class="strength-bars">
              <div v-for="i in 4" :key="i" class="strength-bar" :class="{ active: pwdStrength >= i, [`s${pwdStrength}`]: true }" />
            </div>
...
<style scoped>
/* Reuse all styles from login.vue — copy the full <style> block */
.login-wrap {
  display: flex;
  height: 100vh;
  width: 100vw;
...
.strength-bar.active.s1 { background: var(--offline); }
.strength-bar.active.s2 { background: var(--warning); }
.strength-bar.active.s3 { background: var(--accent); }
.strength-bar.active.s4 { background: var(--accent); }
